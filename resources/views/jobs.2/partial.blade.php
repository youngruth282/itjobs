...
?>
    ...
    {{ Form::hidden('app_deptid', $deptid) }}

    <div class="col-xs-12">
        <div class="form-group row">        
            <label for="crewname" class="col-sm-2 col-form-label text-right">負責同工：</label>
            <div class="col-sm-4">
                {!! Form::text('app_crewname', null, ['placeholder' => '請填寫負責同工姓名','class' => 'form-control']) !!}
            </div>
        </div>
    </div>
